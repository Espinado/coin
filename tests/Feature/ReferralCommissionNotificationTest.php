...
class ReferralCommissionNotificationTest extends TestCase
{
    ...
    public function test_referral_purchase_does_not_notify_when_referral_activity_toggle_is_off(): void
    {
        ...
        Event::assertNotDispatched(ReferralCommissionPaid::class);
    }

    public function test_referral_purchase_sends_email_and_broadcasts_realtime_event_when_toggle_is_on(): void
    {
        Event::fake([ReferralCommissionPaid::class]);
        Mail::fake();
    ...
    public function test_referral_upgrade_does_not_notify_when_referral_activity_toggle_is_off(): void
    {
        Event::fake([ReferralCommissionPaid::class]);
        Mail::fake();
    ...
    public function test_referral_upgrade_sends_email_and_broadcasts_realtime_event_when_toggle_is_on(): void
    {
        Event::fake([ReferralCommissionPaid::class]);
        Mail::fake();
