            ...
            <table class="payment-logs-table__grid">
                <thead>
                    <tr style="text-align:left;border-bottom:1px solid rgba(255,255,255,0.08);">
                        ...
                        <th style="padding:12px 18px;">{{ strtoupper(__('coin.admin.result')) }}</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($groups as $group)
                        <tr class="payment-log-group-row" style="border-bottom:1px solid rgba(255,255,255,0.06);">
                            ...
                            <td style="padding:14px 18px;max-width:320px;">{{ \Illuminate\Support\Str::limit($group->summaryMessage(), 120) }}</td>
                            ...
                            <td style="padding:14px 18px;white-space:nowrap;" class="payment-log-group__result">{{ $group->latestResultLabel() }}</td>
                        </tr>
                    @empty
                        <tr><td colspan="8" style="padding:18px;color:rgba(232,237,245,0.65);">{{ __('coin.admin.no_payment_logs') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
