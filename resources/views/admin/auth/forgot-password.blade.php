...
@section('title', __('coin.admin.page_title', ['section' => __('coin.admin.admins.forgot_password')]))
    ...
    <div class="admin-auth-wrap">
        <div class="admin-card">
            ...
            <p style="margin:10px 0 0;font-size:13.5px;line-height:1.55;color:rgba(232,237,245,0.72);">
                {{ __('coin.admin.admins.forgot_password_sub') }}
            </p>
            ...
            <form method="POST" action="{{ route('admin.password.request.store') }}" style="margin-top:24px;display:flex;flex-direction:column;gap:16px;">
                @csrf
                ...
                <button type="submit" class="admin-btn admin-btn-primary" style="width:100%;padding:12px;">{{ __('coin.admin.admins.send_reset_link') }}</button>
            </form>
