  ...
  <div class="coin-landing-hero__grid">
    <div class="coin-landing-hero__copy">
      <div style="display: inline-flex; align-items: center; gap: 10px; padding: 7px 14px; border-radius: 999px; border: 1px solid rgba(150,235,250,0.2); background: rgba(150,235,250,0.06); font-family: 'JetBrains Mono', monospace; font-size: 11px; letter-spacing: 0.14em; color: oklch(0.88 0.11 195);">
        <span style="width: 6px; height: 6px; border-radius: 50%; background: oklch(0.85 0.15 160); animation: paiPulse 2.4s infinite;"></span>{{ __('coin.landing.hero_badge') }}
      </div>
    ...
    <div class="coin-landing-hero__visual">
      <div class="coin-landing-hero__visual-card">
        <div style="display: flex; align-items: center; justify-content: space-between;">
          <span style="font-family: 'JetBrains Mono', monospace; font-size: 10.5px; letter-spacing: 0.14em; color: rgba(230,244,250,0.72);">{{ __('coin.landing.hero_visual_title') }}</span>
          <span style="display: flex; align-items: center; gap: 7px; font-family: 'JetBrains Mono', monospace; font-size: 10.5px; color: oklch(0.88 0.14 160);"><span style="width: 6px; height: 6px; border-radius: 50%; background: oklch(0.85 0.15 160); animation: paiPulse 2.2s infinite;"></span>{{ __('coin.landing.status_online') }}</span>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-top: 22px;">
          <div style="padding: 12px; border-radius: 14px; border: 1px solid rgba(150,235,250,0.12); background: rgba(4,16,28,0.6); display: flex; flex-direction: column; gap: 7px;">
            ...
            <div style="margin-top: 2px; font-family: 'JetBrains Mono', monospace; font-size: 9.5px; letter-spacing: 0.1em; color: rgba(230,244,250,0.68);">{{ __('coin.landing.mock_dc', ['n' => '01']) }}</div>
          </div>
          <div style="padding: 12px; border-radius: 14px; border: 1px solid oklch(0.86 0.11 195 / 0.3); background: rgba(4,16,28,0.6); display: flex; flex-direction: column; gap: 7px; box-shadow: inset 0 0 26px oklch(0.6 0.13 200 / 0.25);">
            ...
            <div style="margin-top: 2px; font-family: 'JetBrains Mono', monospace; font-size: 9.5px; letter-spacing: 0.1em; color: oklch(0.88 0.1 205);">{{ __('coin.landing.mock_dc', ['n' => '02']) }}</div>
          </div>
          <div style="padding: 12px; border-radius: 14px; border: 1px solid rgba(150,235,250,0.12); background: rgba(4,16,28,0.6); display: flex; flex-direction: column; gap: 7px;">
            ...
            <div style="display: flex; align-items: center; gap: 7px;"><span style="width: 5px; height: 5px; border-radius: 50%; background: rgba(150,235,250,0.3);"></span><span style="flex: 1; height: 3px; border-radius: 2px; background: rgba(150,235,250,0.14);"></span></div>
            <div style="margin-top: 2px; font-family: 'JetBrains Mono', monospace; font-size: 9.5px; letter-spacing: 0.1em; color: rgba(230,244,250,0.68);">{{ __('coin.landing.mock_dc', ['n' => '03']) }}</div>
          </div>
        </div>
        ...
        <div style="margin-top: 20px; padding: 18px; border-radius: 16px; border: 1px solid rgba(150,235,250,0.12); background: rgba(150,235,250,0.04);">
          <div style="display: flex; align-items: center; justify-content: space-between; gap: 12px; flex-wrap: wrap;">
            <span style="font-size: 13.5px; color: rgba(230,244,250,0.78);">{{ __('coin.landing.hero_active_power') }}</span>
            <span style="font-family: 'JetBrains Mono', monospace; font-size: 15px; color: #f0fbff;">{{ $landingStats['featured_power_label'] ?? '—' }}</span>
          </div>
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; gap: 12px; flex-wrap: wrap; margin-top: 18px;">
            <span style="font-size: 13.5px; color: rgba(230,244,250,0.78);">{{ __('coin.landing.hero_accrued_today') }}</span>
            <span style="font-family: 'JetBrains Mono', monospace; font-size: 15px; color: oklch(0.9 0.12 192);">{{ $landingStats['featured_daily_label'] ?? '—' }}</span>
          </div>
        </div>
      </div>
    </div>
