<section class="coin-landing-hero" data-screen-label="Hero">
  <div class="coin-landing-hero__grid">
    <div>
      ...
      <h1 class="coin-landing-hero__title">Активируйте AI-мощность и получайте вознаграждение</h1>
      <p class="coin-landing-hero__lead">Вы выбираете тариф, получаете вычислительную мощность на базе дата-центров и видите начисления в личном кабинете. Без покупки и обслуживания оборудования.</p>
