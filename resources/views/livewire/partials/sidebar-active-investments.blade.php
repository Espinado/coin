<div class="coin-sidebar-investments">
  ...
  @else
  <div style="margin-top: 12px; display: flex; flex-direction: column; gap: 10px; max-height: 240px; overflow-y: auto; padding-right: 2px;">
    ...
    <div wire:key="sidebar-contract-{{ $contract->id }}" style="padding: 12px; border-radius: 11px; border: 1px solid rgba(150,235,250,0.14); background: rgba(4,16,28,0.35);">
      <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 8px;">
        ...
        <button type="button" wire:click="setSection(2)" style="flex: none; border: 0; background: transparent; padding: 0; font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.08em; color: oklch(0.88 0.11 195); cursor: pointer;">{{ mb_strtoupper(__('coin.actions.open')) }}</button>
      </div>
