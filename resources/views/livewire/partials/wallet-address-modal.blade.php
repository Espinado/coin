  ...
  >
    <div style="padding: 18px 22px; border-bottom: 1px solid rgba(150,235,250,0.1); display: flex; align-items: flex-start; justify-content: space-between; gap: 12px;">
      <div style="min-width: 0;">
        <div style="font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.14em; color: rgba(214,238,248,0.62);">{{ mb_strtoupper(__('coin.profile.connected_wallet')) }}</div>
        ...
        <div style="margin-top: 6px; font-size: 12.5px; color: rgba(214,238,248,0.72);">
          {{ $walletModalMode === 'disconnect' ? __('coin.profile.disconnect_wallet_hint') : __('coin.profile.payout_address_hint', ['network' => $this->payoutNetworkLabel]) }}
        </div>
      </div>
