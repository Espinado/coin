...
**Coin** — инвестиционная платформа. Пользователь пополняет счёт (**USDT / BTC**), покупает **план** (это депозит с фиксированным сроком и процентом), получает **ежедневную прибыль**, выводит средства по правилам ниже. Пригласивший получает **20% от суммы покупок планов** своих рефералов и **20% от доплаты**, если реферал повышает план на более дорогой (разница между min нового плана и текущим principal).
...
- **Комиссия:** **20%** от суммы **покупки плана** рефералом и **20% от доплаты при upgrade** (не от прибыли, не level 2)
