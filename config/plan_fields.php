...
return [
    ...
    'fields' => [
        ...
        'price_label' => [
            ...
            'type' => 'text',
            'step' => null,
            'help' => 'Маркетинговый текст вроде «$1 100» или «По договору». Не сумма списания с баланса.',
        ],
        'infra' => [
            'label' => 'Название пула',
            'section' => 'display',
        ...
        'annual_profit_percent' => [
            ...
            'type' => 'number',
            'step' => '0.01',
            'help' => 'Считает дневную прибыль: тело × APR ÷ 365. Копируется в договор при покупке.',
        ],
        'currency' => [
            'label' => 'Валюта',
            'section' => 'purchase',
        ...
        'duration_days' => [
            ...
            'type' => 'number',
            'step' => null,
            'help' => 'Сколько дней тело остаётся заблокированным. Пусто → «По договору» в интерфейсе.',
        ],
        'daily_estimate' => [
